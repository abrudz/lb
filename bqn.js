; (_ => {
 ...
 <style>@font-face{font-family:"BQN386 Unicode";src:local("BQN386 Unicode"),url(//abrudz.github.io/lb/BQN386.ttf)format('ttf');}</style>
 <style>
  .ngn_lb{position:fixed;top:0;left:0;right:0;background-color:#eee;color:#000;cursor:default;z-index:2147483647;
    font-family:"BQN386 Unicode",monospace;border-bottom:solid #999 1px;padding:2px 2px 0 2px;word-wrap:break-word;}
